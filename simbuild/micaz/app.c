...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2ba72be491f0, const void *arg_0x2ba72be494c8);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 252
extern double erfc(double arg_0x2ba72becb9c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
...
unsigned int (*hashfunction)(void *arg_0x2ba72c119868), 
int (*key_eq_fn)(void *arg_0x2ba72c118020, void *arg_0x2ba72c1182c0));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2ba72c308288, int arg_0x2ba72c3084f0);
static double RandomUniform(void );
...
#line 284
...

    {
      ...
      int16_t myDistance = RoutC$distance(TOS_NODE_ID);
      int16_t annDistance = RoutC$distance(__nesc_ntoh_uint16(mess->from.nxdata));

      if (RoutC$router[sim_node()] == -1 && myDistance > annDistance) {
          RoutC$router[sim_node()] = __nesc_ntoh_uint16(mess->from.nxdata);
        }
      else {
#line 302
        if (RoutC$router[sim_node()] != -1) {
            int16_t routerDistance = RoutC$distance(RoutC$router[sim_node()]);
            int16_t currentCost = RoutC$batteryRequiredForSend(RoutC$router[sim_node()]);
            int16_t annCost = RoutC$batteryRequiredForSend(__nesc_ntoh_uint16(mess->from.nxdata));



            if (routerDistance >= annDistance) {
                RoutC$router[sim_node()] = __nesc_ntoh_uint16(mess->from.nxdata);
              }
          }
        }
...
# 67 "/opt/tinyos-2.1.0/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x2ba72c7cd450, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2ba72c7cd450) {
#line 67
    case 7:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x2ba72c7cd450, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 81
# 69 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x2ba72cc68020, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x2ba72cc68020, addr, msg, len);
#line 69
...
# 99 "/opt/tinyos-2.1.0/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x2ba72c79c328, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x2ba72c79c328, msg, error);
#line 99
}
#line 99
...
# 67 "/opt/tinyos-2.1.0/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x2ba72c7cc020, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x2ba72c7cc020, msg, payload, len);
#line 67
...
# 89 "/opt/tinyos-2.1.0/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x2ba72cc6ae18, message_t * msg, error_t error){
#line 89
  switch (arg_0x2ba72cc6ae18) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x2ba72cc6ae18, msg, error);
#line 89
      break;
#line 89
    }
...
# 64 "/opt/tinyos-2.1.0/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x2ba72c42aab0){
#line 64
  switch (arg_0x2ba72c42aab0) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x2ba72c42aab0);
#line 64
      break;
#line 64
    }
...
# 72 "/opt/tinyos-2.1.0/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x2ba72ca422f8){
#line 72
  switch (arg_0x2ba72ca422f8) {
#line 72
    case 0U:
#line 72
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x2ba72ca422f8);
#line 72
      break;
#line 72
    }
